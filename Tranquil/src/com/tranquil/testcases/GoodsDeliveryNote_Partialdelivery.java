...
public class GoodsDeliveryNote_Partialdelivery 
{
	...
	@Test(priority = 2)
	public void GoodsDelivery_from_Salesorder_partial1() throws Throwable
	{
		SalesOrderlist salesorderlist = PageFactory.initElements(driver, SalesOrderlist.class);
		SalesOrder salesorder = PageFactory.initElements(driver, SalesOrder.class);
		GoodsDelivery goodsdelivery = PageFactory.initElements(driver, GoodsDelivery.class);
		...
		Thread.sleep(1000);
		goodsdelivery.enter_orderqty(driver,"1","1");
		Thread.sleep(1000);
		goodsdelivery.select_checkbox(driver,"3");
		Thread.sleep(1000);
		goodsdelivery.enter_orderqty(driver,"3","2");
		goodsdelivery.click_save();
		Thread.sleep(2000);
	}
	
	@Test(priority = 3)
	public void GoodsDelivery_from_Salesorder_partial2() throws Throwable
	{
		SalesOrderlist salesorderlist = PageFactory.initElements(driver, SalesOrderlist.class);
		SalesOrder salesorder = PageFactory.initElements(driver, SalesOrder.class);
		GoodsDelivery goodsdelivery = PageFactory.initElements(driver, GoodsDelivery.class);
		...
		Assert.assertEquals("1.000",goodsdelivery.get_dlverdqty1());
		System.out.println("Goodsdelivery-deliverdqty1 is correct");
		...
		Assert.assertEquals("2.000",goodsdelivery.get_dlverdqty3());
		System.out.println("Goodsdelivery-deliverdqty3 is correct");
		
		
		Assert.assertEquals(goodsdelivery.get_balqty1calculated()+"00",goodsdelivery.get_balqty1());
		System.out.println("Goodsdelivery-balqty1 is correct");
		
		Assert.assertEquals(goodsdelivery.get_balqty2calculated()+"00",goodsdelivery.get_balqty2());
		System.out.println("Goodsdelivery-balqty2 is correct");
		
		Assert.assertEquals(goodsdelivery.get_balqty3calculated()+"00",goodsdelivery.get_balqty3());
		System.out.println("Goodsdelivery-balqty3 is correct");
		
		Assert.assertEquals(goodsdelivery.get_balqty1calculated()+"00",goodsdelivery.get_qty1());
		System.out.println("Goodsdelivery-qty1 is correct");
		
		Assert.assertEquals(goodsdelivery.get_balqty2calculated()+"00",goodsdelivery.get_qty2());
		System.out.println("Goodsdelivery-qty2 is correct");
		
		Assert.assertEquals(goodsdelivery.get_balqty3calculated()+"00",goodsdelivery.get_qty3());
		System.out.println("Goodsdelivery-qty3 is correct");
		...
		Assert.assertEquals("Each",goodsdelivery.get_uom2());
		System.out.println("Goodsdelivery-uom2 is correct");
		
		Assert.assertEquals("Each",goodsdelivery.get_uom3());
		System.out.println("Goodsdelivery-uom3 is correct");
		...
		goodsdelivery.select_checkbox(driver,"1");
		Thread.sleep(1000);
		goodsdelivery.enter_orderqty(driver,"1",String.valueOf(goodsdelivery.get_balqty1calculated()));
		Thread.sleep(1000);
		goodsdelivery.select_checkbox(driver,"2");
		Thread.sleep(1000);
		goodsdelivery.enter_orderqty(driver,"2",String.valueOf(goodsdelivery.get_balqty3calculated()));
		Thread.sleep(1000);
		goodsdelivery.click_save();
		Thread.sleep(2000);
	}
